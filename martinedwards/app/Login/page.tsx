    ...
    <div className="relative min-h-screen overflow-hidden bg-[#561C24]">
        ...
        <div className="relative w-full max-w-[430px]">
          ...
          <div className="relative bg-[#F5F5F5] rounded-[28px] md:rounded-[30px] px-6 py-10 md:px-10 md:py-14 shadow-[0_20px_50px_rgba(0,0,0,0.25)]">
            ...
            <button
              ...
              className="hidden md:flex absolute top-2 -left-16 w-11 h-11 rounded-full bg-white/15 backdrop-blur-md items-center justify-center text-white transition-all hover:bg-white/30"
            >
              <ArrowLeft size={22} />
            </button>

            <h1 className="text-center text-3xl md:text-5xl font-bold text-black font-sans">
              Masuk
            </h1>
            ...
            <div className="mt-8 flex flex-col gap-5 text-black">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  className={`w-full h-[60px] rounded-2xl border ${
                    errors.userId
                      ? "border-red-500"
                      : "border-black/30"
                  } px-5 outline-none focus:border-[#8B3039] duration-300`}
                />

                {errors.userId && (
                  <span className="text-red-500 text-[11px] ml-2 font-medium">
                    {errors.userId}
                  </span>
                )}
              </div>
              ...
              <div className="flex flex-col gap-1.5">
                  ...
                  <input
                    ...
                    className={`w-full h-[60px] rounded-2xl border ${
                      errors.password
                        ? "border-red-500"
                        : "border-black/30"
                    } px-5 pr-14 outline-none focus:border-[#8B3039] duration-300`}
                  />
                ...
                <div className="flex justify-end px-1">
                  ...
                  <button
                    ...
                    className="mt-1 text-[12px] font-semibold text-[#8B3039] hover:underline"
                  >
                    Lupa kata sandi?
                  </button>
                </div>
      ...
      {forgotOpen && (
        <div
          ...
          className="fixed inset-0 z-[60] flex items-center justify-center bg-black/40 backdrop-blur-sm px-5 animate-fadeIn"
        >
          <div
            onClick={(e) =>
              e.stopPropagation()
          ...
          >
            ...
            <p className="mt-8 text-xs text-gray-400">
              Tekan dimana pun untuk kembali
            </p>
